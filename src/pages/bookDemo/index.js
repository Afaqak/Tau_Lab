  ...
  return (
    <>
      <div className="min-h-screen bg-black ">
        <div className=" h-[85vh]  overflow-hidden p-4 text-white px-4 lg:px-16 relative bg-black">
          <Navbar />
          <motion.div
          ...
          <div className="relative mt-48">
            <motion.h1
              ...
              className="lg:w-1/2 text-3xl font-medium lg:text-6xl leading-tight"
            >
              Request Demo
            </motion.h1>
            <div className="lg:w-1/2 mt-6 flex flex-col gap-16">
              <motion.p
                initial={{ opacity: 0, scale: 0.5 }}
                animate={{ opacity: 1, scale: 1 }}
                transition={{ duration: 1 }}
        ...
        <div class="container mx-auto py-8 w-[60%]">
          ...
          <form>
            ...
            <div className="mt-6">
              <button className="bg-blue-500 text-2xl text-white font-bold hover:bg-black transition-all duration-300 ease-in-out border-2 rounded-full border-white border-w px-16 py-2 w-[30%] -ml-4">
                Submit
              </button>
            </div>
          </form>
